...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'Designed an integrated access technology system — a companion mobile app and smart cane — to support a user living with Postural Orthostatic Tachycardia Syndrome (POTS). Through primary and secondary research, our team identified critical pain points in daily symptom management and designed a solution that detects episodes via heart rate monitoring, guides breathing exercises, logs symptoms, and provides emergency support.',
