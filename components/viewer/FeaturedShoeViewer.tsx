                ...
                <div className="relative h-[480px] md:h-[650px] mb-6 group cursor-grab active:cursor-grabbing rounded-[40px] overflow-hidden bg-gradient-to-b from-[#0a0a0a] to-[#121212] border border-white/5 shadow-2xl">
                    <Suspense fallback={<ViewerSkeleton />}>
                        {currentProject.viewer.type === '3d' ? (
                            <ThreeModelViewer
                                ...
                                // Use deviceType directly from project configuration
                                deviceType={currentProject.viewer.deviceType || 'phone'}
                                onScreenClick={() => setIsGalleryOpen(true)}
                            />
                        ) : (
                    ...
                    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center opacity-90 hover:opacity-100 transition-opacity">
                        <motion.button
                            ...
                            className="px-6 py-3.5 bg-[#ff4d2e] hover:bg-[#ff6b52] text-white rounded-full font-bold transition-all shadow-[0_0_20px_rgba(255,77,46,0.3)] hover:shadow-[0_0_30px_rgba(255,77,46,0.5)] flex items-center gap-2 border border-[#ff4d2e]"
